...
// This program is a "what-if" grade calculator (for now).
...
public class Main {
  ...
  public static void main(String[] args) {
     ...
     */
      ...
      final double MAXSCORE = 100.00;//grade cannot exceed 100%
      final double MAXWEIGHT = 100.00;//Weight cannot exceed 100
     
      double sumScore = (pro1+pro2+pro3+pro4);//gets the sum of the grades
      double averageScore = sumScore/proNum;//calculates the average
    
      System.out.println("The number of assignments being graded: \t"+proNum);
      System.out.println("Your sum score: \t" + sumScore);
      System.out.println("Your current grade: \t" +averageScore);
      
    // ctrl+shift+F style formatter
    }
