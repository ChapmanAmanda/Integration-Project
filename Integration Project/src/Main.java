...
public class Main {
    ...
    public static void main(String[] args) {
      ...
      System.out.print("Enter the number of assignments being graded: \t");
      int proNum = input.nextInt(); // gets number of assignments
      
      String proScore = "Enter your grade for your next assignment: \t";
      System.out.println(proScore);
      double pro1 = input.nextDouble(); //gets current score for project 1
      double pro2 = input.nextDouble();
      double pro3 = input.nextDouble();
      double pro4 = input.nextDouble();
      input.nextLine();
      
      boolean doubleCheck = true;
      final double MAXSCORE = 100.00; //grade cannot exceed 100.00
      final double MAXWEIGHT = 100.00; //Weight cannnot exceed 100.00
      
      //Calculates just sum and average for now
      double sumScore = pro1+pro2+pro3+pro4;
      double averageScore = sumScore/proNum;
      
      //prints the information to the user
      System.out.println("The number of assignments being graded: \t"+proNum);
      System.out.println("Your current average score is: \t" + averageScore);
